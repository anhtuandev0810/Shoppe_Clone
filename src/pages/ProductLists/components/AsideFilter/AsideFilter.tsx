          ...
          return (
            <li className='py-2 pl-2 ' key={categoryItem._id}>
              ...
              >
                <svg
                  viewBox='0 0 4 7'
                  className={classNames('fill-orange h-2 w-2 absolute top-1 left-[-10px]', {
                    'text-orange font-semibold': isActive
                  })}
                >
              ...
              render={({ field }) => {
                return (
                  <InputNumber
                    ...
                    className='grow'
                    name='form'
                    classNameInput='p-1 w-full outline-none border border-gray-300 focus:border-gray-400 rounded-sm focus:shadow-sm'
                    placeholder='$ Từ'
                    onChange={(event) => {
